...
class vistaModelo
{
    ...
    protected static function obtener_vistas_modelo_alumno($vistas){
        ...
        $listaBlanca=["home","login","mis-cursos","solicitudes","documentacion","FAQs","perfil","servicio-social","template", "ficha-inscripcion","constancias", "mi-perfil", "faqs", "inscripcion"];
        #Verificamos si la vista que esta entrando esta en la lista blanca para poder moestrarla
        if (in_array($vistas,$listaBlanca))
        {
