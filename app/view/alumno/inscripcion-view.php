                            ...
                            <div class="card-body py-4 px-5 d-flex">
                                ...
                                <div class="col-sm-4 m-auto">
                                    <div class="col-sm-12 d-flex justify-content-end">
                                        <button type="button" class="btn btn-primary me-1 mb-1" data-bs-toggle="modal" data-bs-target="#solicitud">Inscribirse</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="tab-pane fade table-responsive active show" id="lista-alumnos" role="tabpanel" aria-labelledby="lista-alumnos-tabla">
                                        ...
                                        <div id="containerTblPresencial">
                                            <div class="alert alert-info d-flex align-items-center" role="alert">
                                                <svg class=" flex-shrink-0 me-2" width="50px" height="50" role="img" aria-label="Info:">
                                                ...
                                                <div>
                                                    ...
                                                    <p>No encontramos horarios registrados. Si este curso es solo virtual omita este mensaje. Agregue el
                                                        horario si es la primera vez que condigura este curso</p>
                                                    <hr>
