...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-08-2022 a las 03:52:50
...
--
ALTER TABLE `asignacion_grupo`
  MODIFY `id_asignacion` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `servicio_social`
  ADD CONSTRAINT `servicio_social_ibfk_1` FOREIGN KEY (`id_alumno_fk`) REFERENCES `alumno` (`id_alumno`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `validacion_inscripcion`
  ADD CONSTRAINT `validacion_inscripcion_ibfk_1` FOREIGN KEY (`id_inscripcion_fk`) REFERENCES `inscripcion` (`id_inscripcion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `validacion_inscripcion_ibfk_2` FOREIGN KEY (`id_profesor_admin_fk`) REFERENCES `administrador` (`id_profesor_admin_fk`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
